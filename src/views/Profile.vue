<template>
  <div class="profile">
    ...
    <div class="container row" v-if="user">
      <div class="card border-0 mt-3 col" id="img-items">
        <img
          :src="
            user.decodedProfileImage ||
      ...
      <div class="card mt-3 border-0 col" id="text-items">
        <h4>{{ user.name }}</h4>
